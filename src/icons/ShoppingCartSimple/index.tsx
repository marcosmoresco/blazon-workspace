...
export default function ShoppingCartSimpleIcon(props:IconProps) {
  ...
  return (
    <svg width={`${width || 32}`} height={`${height || 32}`} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9 28.5C9.82843 28.5 10.5 27.8284 10.5 27C10.5 26.1716 9.82843 25.5 9 25.5C8.17157 25.5 7.5 26.1716 7.5 27C7.5 27.8284 8.17157 28.5 9 28.5Z" fill={`${color || 'black'}`}/>
      <path d="M24 28.5C24.8284 28.5 25.5 27.8284 25.5 27C25.5 26.1716 24.8284 25.5 24 25.5C23.1716 25.5 22.5 26.1716 22.5 27C22.5 27.8284 23.1716 28.5 24 28.5Z" fill={`${color || 'black'}`}/>
    </svg>
  )
} 