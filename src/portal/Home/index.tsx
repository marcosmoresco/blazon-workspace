...
import type { HomeProps, HomeState } from './types'
...
class Home extends Component<HomeProps, HomeState> {
  ...
  render() {
    ...
    const { open, passwordVault } = this.state

    const recentPasswords = [{
      id: 1,
      title: 'Login instagram',
      text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
      username: '@mateusdavid'
    }, {
      id: 2,
      title: 'Login instagram',
      text: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit...',
          ...
          <Grid item xs={6}>
            <div className={classes.recentPasswords}>
              ...
              <div className={classes.recentPasswordsContent}>
                <Grid container spacing={3}>            
                  {recentPasswords.map((r) => (
                    <Grid 
                      item 
                      xs={6} 
                      key={`recenter-password=${r.id}`} 
                      onClick={() => this.setState({open: true, passwordVault: r})}>
