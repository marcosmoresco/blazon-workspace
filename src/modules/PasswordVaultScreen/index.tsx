...
import ShareDialog from '@modules/User/UserAccess/SharedDialog'
...
const PasswordVaultScreen: FC<PasswordVaultScreenProps> = ({
  ...
  const [savePasswordStatus, setSavePasswordStatus] = useState<
    boolean | undefined
  >(undefined)
  ...
  return (
    <div className={classes.passwordVault}>
      ...
      <ShareDialog
        modalOpen={showShareDialogModal}
        setModalOpen={setShowShareDialogModal}
