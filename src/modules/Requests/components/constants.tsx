...
export const filters: FilterType[] = [
  ...
  },
  {
    ...
    values: [{
      ...
      label: <FormattedMessage id="request.type.CHECKIN_ADMIN_ACCOUNT_PASSWORD" />,
      value: "CHECKIN_ADMIN_ACCOUNT_PASSWORD"
    }, {
      label: <FormattedMessage id="request.type.CHECKIN_APPLICATION_ACCOUNT_PASSWORD" />,
      value: "CHECKIN_APPLICATION_ACCOUNT_PASSWORD"
    }, {
      label: <FormattedMessage id="request.type.CHECKOUT_ADMIN_ACCOUNT_PASSWORD" />,
  ...
  },
  {
    ...
    async: (dispatch: any, query: string, callback: any) => {
      ...
      .then(({ data }) => {        
        callback(data?.getUserFullText.map((u) => ({
          ...u       
        })));       
      });       
    }
