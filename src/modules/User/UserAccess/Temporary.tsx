...
import EmptyStateTemporaryAccountImage from "@images/EmptyStateTemporaryAccount.svg";
...
const Temporary = ({ classes }) => {
  ...
  return (
    <CardScreen
      loading={false}
      title="profile.accounts.temporary"       
    ...
    >
      ...
      <div>
        <DataGrid
          emptyStateImage={EmptyStateTemporaryAccountImage}
